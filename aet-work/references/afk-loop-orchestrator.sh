...
#
# Examples:
#   Kimi:    kimi --afk -p "Run aet-work on $plan_file" -w "$worktree_dir"
#   Claude:  claude --print --dangerously-skip-permissions "Run aet-work on $plan_file" --add-dir "$worktree_dir"
