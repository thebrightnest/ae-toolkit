...
# aet-work orchestrator — generated by aet-work run-scripted
# Do not edit by hand; regenerate with: aet-work run-scripted
#
...
# ---------------------------------------------------------------------------
# Detected CLI configuration — filled in by aet-work run-scripted
# ---------------------------------------------------------------------------
CLI_BIN="{{CLI_BIN}}"
CLI_ARGS=({{CLI_ARGS}})
