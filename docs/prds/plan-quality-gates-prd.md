...
_Notes: No conflicts. aet-validate-ui merge must not lose its checklist content — migrate to aet-validate-scope/references/. Self-consistency lint should run as part of aet-plan completion, not as a separate gate._
