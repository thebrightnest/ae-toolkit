...
### R-5: Decision Record (ADR-069)
Record the partitioned layout, optional archive tracking, and missing-file closure semantics in `docs/adr/069-partitioned-plan-directory-layout.md`.
...
| **`ppa-03-adr-conventions-and-skills-sync`** | Record ADR-069, update templates, `.gitignore`, and skill documentation | S | `ppa-02` | `docs/adr/`, `docs/CONVENTIONS.md`, `skills/`, `.gitignore` |
