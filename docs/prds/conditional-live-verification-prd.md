...
_Notes: No conflicts. Assumes work-class routing (PRD 1) is in place to trigger conditionally. Foundation smoke scaffold should align with aet-setup conventions._
