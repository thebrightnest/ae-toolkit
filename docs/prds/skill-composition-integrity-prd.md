...
_Notes: No direct conflicts, but this is the highest-risk change — touches all 21 skills via build system. Recommend implementing after PRD 1 (routing) and before PRD 3/4 (skill content updates) so updates are assembled from partials._
