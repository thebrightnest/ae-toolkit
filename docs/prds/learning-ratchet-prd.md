...
*Notes: No conflicts. Schema addition (trigger field) is backward-compatible with existing learnings.jsonl. Escalation ladder documentation lives in aet-evolve/references/ to keep SKILL.md under 400 lines.*
