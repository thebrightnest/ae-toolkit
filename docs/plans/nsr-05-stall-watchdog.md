...
- [x] New source coverage — `tests/test_stall_watchdog.py`:
...
- [x] R-trace coverage: R-9 by tasks 1–3; R-10 by tasks 3–4; R-13 by task 5; no unknown R-ids
- [x] Distinguish test types: unit (watchdog timing with a fake clock/process) + integration (finalize routing)
