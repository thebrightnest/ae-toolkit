...
- `aet ship merge <plan_file|task_id> --branch <target>` — run the gate, detect conflicts against the target branch, merge directly into it, and record closure. `--branch` defaults to `main`.
