...
- [ ] `.gitignore` excludes generated agent artifacts (`.agents/work-queue.json`, `.agents/work-queue.json.lock`, `.agents/work-queue.lease`, `.agents/work-history.jsonl`, `aet-work.log`, `aet-work-*.log`)?
